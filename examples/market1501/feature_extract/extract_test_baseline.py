...
def get_feature(img_file):
        ...
        return scores
def extract_dir():
	f_images=open('/home/dlutdip/caffe-master/examples/market1501/image_list/test_list.txt','rb')
	...
	i = 0
		...
		i = i + 1
                ...
                f = open('/home/dlutdip/caffe-master/examples/market1501/feature_extract/test_baseline_512dim','ab')
 	        f.write(feature)
        	f.close()
	f_images.close()
extract_dir()
