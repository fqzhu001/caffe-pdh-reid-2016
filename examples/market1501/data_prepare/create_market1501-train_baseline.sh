...
ANCHOR_TRAIN_DATA_ROOT=/home/dlutdip/caffe-master/examples/market1501/Market-1501-v15.09.15
POS_TRAIN_DATA_ROOT=/home/dlutdip/caffe-master/examples/market1501/Market-1501-v15.09.15
NEG_TRAIN_DATA_ROOT=/home/dlutdip/caffe-master/examples/market1501/Market-1501-v15.09.15
...
GLOG_logtostderr=1 $TOOLS/convert_imageset \
    ...
    $DATA/anchor-train.txt \
    $EXAMPLE/market1501_anchor_train_lmdb
...
GLOG_logtostderr=1 $TOOLS/convert_imageset \
    ...
    $POS_TRAIN_DATA_ROOT \
    $DATA/pos-train.txt \
    $EXAMPLE/market1501_pos_train_lmdb
...
GLOG_logtostderr=1 $TOOLS/convert_imageset \
    ...
    $NEG_TRAIN_DATA_ROOT \
    $DATA/neg-train.txt \
    $EXAMPLE/market1501_neg_train_lmdb
