...
GLOG_logtostderr=1 $TOOLS/convert_imageset \
    ...
    $DATA/part-3-anchor-train.txt \
    $EXAMPLE/market1501_anchor_train_lmdb_part_3
...
GLOG_logtostderr=1 $TOOLS/convert_imageset \
    ...
    --backend="lmdb" \
    $POS_TRAIN_DATA_ROOT \
    $DATA/part-3-pos-train.txt \
    $EXAMPLE/market1501_pos_train_lmdb_part_3
...
GLOG_logtostderr=1 $TOOLS/convert_imageset \
    ...
    --backend="lmdb" \
    $NEG_TRAIN_DATA_ROOT \
    $DATA/part-3-neg-train.txt \
    $EXAMPLE/market1501_neg_train_lmdb_part_3
