...
GLOG_logtostderr=1 $TOOLS/convert_imageset \
    ...
    $DATA/part-4-anchor-train.txt \
    $EXAMPLE/market1501_anchor_train_lmdb_part_4
...
GLOG_logtostderr=1 $TOOLS/convert_imageset \
    ...
    --backend="lmdb" \
    $POS_TRAIN_DATA_ROOT \
    $DATA/part-4-pos-train.txt \
    $EXAMPLE/market1501_pos_train_lmdb_part_4
...
GLOG_logtostderr=1 $TOOLS/convert_imageset \
    ...
    --backend="lmdb" \
    $NEG_TRAIN_DATA_ROOT \
    $DATA/part-4-neg-train.txt \
    $EXAMPLE/market1501_neg_train_lmdb_part_4
