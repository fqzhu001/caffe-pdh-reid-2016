...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='triplet_rank_loss_param', full_name='caffe.LayerParameter.triplet_rank_loss_param', index=50,
...
_TRIPLETRANKLOSSPARAMETER = _descriptor.Descriptor(
  name='TripletRankLossParameter',
  full_name='caffe.TripletRankLossParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='margin', full_name='caffe.TripletRankLossParameter.margin', index=0,
      number=1, type=2, cpp_type=6, label=1,
...
_LAYERPARAMETER.fields_by_name['triplet_rank_loss_param'].message_type = _TRIPLETRANKLOSSPARAMETER
...
DESCRIPTOR.message_types_by_name['TripletRankLossParameter'] = _TRIPLETRANKLOSSPARAMETER
...
class TripletRankLossParameter(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _TRIPLETRANKLOSSPARAMETER

  # @@protoc_insertion_point(class_scope:caffe.TripletRankLossParameter)
